  ...
  return (
    <section className="md:mt-50 mt-20 ">
      <Container>
        ...
        <h3 className="text-3xl md:text-[50px] md:leading-15 font-medium md:w-130 w-[85%] text-primary font-Vol text-center mx-auto pt-3 pb-10">
          Provide Wide Range of Digital Services
        </h3>
        <Flex className={"gap-10 justify-center flex-col md:flex-row"}>
          <div className="py-13.5 px-7.5 shadow-newMade w-[85%] md:w-95 group">
            <Image src={sOne} alt="sOne" />
            <h6 className="text-2xl font-Vol pt-6.5 pb-4 text-primary font-extrabold">
              Ui/Ux Design
            </h6>
            <p className="md:w-61.25 w-50 font-Jos text-base leading-6 text-primary pb-7.5">
